...
const Checkout = () => {
  ...
  const handlePlaceOrderClick = () => {
    ...
    // Check if all fields are filled (you can add more sophisticated validation if required)
    const isFormFilled =
      name.trim() &&
      email.trim() &&
      number.trim() &&
  ...
  const handlePaypalClick = async () => {
    try {
      ...
      const response = await axios
        .post(
          "https://pzxi5qxce8.ap-southeast-1.awsapprunner.com/create-payment",
          {
            amount: totalAmount,
            orderInfo: {
              name,
        ...
        <ModalBody>
          <form className="form">
            <div className="payment--options">
              ...
              <Button name="apple-pay" type="button" color="primary">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <Button name="google-pay" type="button" color="primary">
                <svg
                  fill="none"
                  viewBox="0 0 80 39"
                  height="39"
            ...
            <div className="credit-card-info--form">
              <div className="input_container">
                <label htmlFor="cardHolder" className="input_label">
              ...
              <div className="input_container">
                <label htmlFor="cardNumber" className="input_label">
                  Card Number
                </label>
                <input
                  id="cardNumber"
              ...
              <div className="input_container">
                <label htmlFor="expiryDate" className="input_label">
                  Expiry Date / CVV
                </label>
                <div className="split">
                  <input
